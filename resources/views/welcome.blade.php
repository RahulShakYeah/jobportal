            ...
            <div class="row">
                <div class="col-md-12 mb-5 mb-md-0" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="rounded border jobs-wrap">
                        @foreach($job as $jobs)
                        <a href="job-single.html" class="job-item d-block d-md-flex align-items-center  border-bottom partime">
                            ...
                            <div class="job-details h-100">
                                <div class="p-3 align-self-center">
                                    ...
                                    <div class="d-block d-lg-flex">
                                        <div class="mr-3"><span class="icon-suitcase mr-1"></span> {{$jobs->cate}}</div>
                                        <div class="mr-3"><span class="icon-room mr-1"></span> {{$jobs->address}}</div>
